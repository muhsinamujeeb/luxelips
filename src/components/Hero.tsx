...
export default function Hero({ onShopNow }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-40 left-1/4 w-2 h-2 bg-hot-pink/30 rounded-full animate-float"
        style={{ animationDelay: '1s' }}
      />
      <div
        className="absolute top-1/3 right-1/3 w-5 h-5 bg-rose-gold/30 rounded-full animate-float-delayed"
          ...
          <div className="text-center lg:text-left space-y-8 animate-fade-in-up">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200 dark:border-gray-700">
              <div className="text-center lg:text-left">
                <div className="text-3xl font-bold text-gradient-luxe">
                  500+
                </div>
